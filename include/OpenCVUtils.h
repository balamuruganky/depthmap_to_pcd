...
public:
  ~OpenCVUtils ();
  OpenCVUtils (DepthBufferInfo * pDepthBufInfo,
	       ColorBufferInfo * pColorBufInfo);
  ...
  ColorBuffer *ConvertColorBufferFromRGBtoBGR (ColorBufferInfo *
...
private:
  ...
  {
    return ((NULL != _pColorBufInfo) ? true : false);
  }
